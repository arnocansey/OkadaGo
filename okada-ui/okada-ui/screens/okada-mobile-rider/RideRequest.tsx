...
export function RideRequest() {
  return (
    <div className="w-[390px] h-[844px] bg-[#0D1A10]/80 flex flex-col items-center justify-center relative overflow-hidden font-sans mx-auto shadow-xl">
      {/* Status Bar */}
      <div className="absolute top-0 left-0 right-0 h-11 flex items-center justify-between px-6 text-sm font-medium z-10 text-white">
        <span>9:41</span>
      ...
      <div className="w-[85%] bg-white rounded-[24px] shadow-2xl overflow-hidden flex flex-col relative animate-in zoom-in-95 duration-300">
        ...
        <div className="px-6 py-4 bg-gray-50/50">
          <div className="flex gap-4 relative">
            ...
            <div className="flex flex-col items-center mt-1">
              <div className="w-3 h-3 rounded-full bg-[#0D6B4A]"></div>
              <div className="w-0.5 h-10 bg-gray-300 border-l border-dashed border-gray-400"></div>
        ...
        <div className="px-6 pb-6 pt-2 flex flex-col gap-3">
          ...
          <button className="w-full bg-white border-2 border-red-100 text-red-600 font-bold py-3.5 rounded-2xl active:bg-red-50 transition-colors">
            Decline
          </button>
        </div>
      </div>
