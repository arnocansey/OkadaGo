...
import { Share2, MessageCircle, AlertTriangle, ShieldAlert } from 'lucide-react';
  ...
  return (
    <div className="w-[390px] h-[844px] bg-[#1A231E] relative overflow-hidden font-sans mx-auto shadow-xl">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Rider Marker (Animated effect) */}
        <div className="absolute top-[600px] left-[150px] transform -translate-x-1/2 -translate-y-1/2 z-20">
          <div className="absolute inset-0 bg-[#FFB800] rounded-full animate-ping opacity-30 scale-150"></div>
          <div className="w-8 h-8 bg-[#FFB800] border-2 border-white rounded-full shadow-lg relative z-10"></div>
        </div>
        {/* Destination Marker */}
      ...
      <div className="absolute bottom-0 left-0 right-0 bg-white rounded-t-[32px] shadow-[0_-8px_30px_rgba(0,0,0,0.12)] z-40 pb-8">
        ...
        <div className="px-6 flex flex-col gap-6">
          ...
          <div className="flex justify-between gap-3">
            <button className="flex-1 bg-gray-100 hover:bg-gray-200 rounded-xl py-3 flex flex-col items-center justify-center gap-1 transition-colors">
            ...
            <button className="flex-1 bg-red-50 hover:bg-red-100 rounded-xl py-3 flex flex-col items-center justify-center gap-1 transition-colors">
