      ...
      <div className="flex-1 overflow-y-auto pb-[calc(6.5rem+env(safe-area-inset-bottom))]">
        <div className="bg-white px-4 py-6 mb-2 border-b border-gray-100 flex flex-col items-center text-center">
          <div className="relative mb-4">
            <div className="w-24 h-24 rounded-full bg-[#0D6B4A] flex items-center justify-center text-white text-3xl font-bold shadow-md">EO</div>
        ...
        <div className="px-4 py-4 bg-white mb-2 border-y border-gray-100 flex divide-x divide-gray-100">
          <div className="flex-1 flex flex-col items-center"><span className="text-xl font-bold text-gray-900">234</span><span className="text-xs text-gray-500 font-medium">Trips</span></div>
          <div className="flex-1 flex flex-col items-center">
            <div className="flex items-center gap-1"><span className="text-xl font-bold text-gray-900">4.7</span><span className="text-[#FFB800] text-sm">★</span></div>
            <span className="text-xs text-gray-500 font-medium">Rating</span>
          </div>
          <div className="flex-1 flex flex-col items-center"><span className="text-xl font-bold text-gray-900">94%</span><span className="text-xs text-gray-500 font-medium">Completion</span></div>
        </div>
        ...
        <div className="px-4 space-y-6 pt-4">
          <section>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-4">
              ...
              <button className="w-full text-sm font-bold text-[#0D6B4A] py-2 border border-green-100 rounded-xl hover:bg-green-50 transition-colors">Edit Details</button>
            </div>
          </section>
          ...
          <section className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-6">
            {[
              ...
              <button key={i} className={cn("w-full flex items-center justify-between p-4 bg-white active:bg-gray-50 transition-colors text-left", i !== arr.length - 1 && "border-b border-gray-50")}>
                <div className="flex items-center gap-3">
                  <div className={cn("w-8 h-8 rounded-full flex items-center justify-center", item.danger ? "bg-red-50 text-red-600" : "bg-gray-50 text-gray-600")}>
                    <item.icon className="w-4 h-4" />
                  </div>
                  <span className={cn("font-semibold text-sm", item.danger ? "text-red-600" : "text-gray-900")}>{item.label}</span>
                </div>
                {!item.danger ? <ChevronRight className="w-4 h-4 text-gray-400" /> : null}
              </button>
            ))}
          </section>
        </div>
