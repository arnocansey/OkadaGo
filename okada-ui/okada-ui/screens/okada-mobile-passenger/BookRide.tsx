...
import { ArrowLeft, MapPin, Bike, Car, Users, CreditCard, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="w-[390px] h-[844px] bg-gray-100 flex flex-col relative overflow-hidden font-sans">
      ...
      <div className="h-[45%] w-full bg-[#e5e7eb] relative overflow-hidden">
        {/* Fake Map Elements */}
        <div className="absolute inset-0 opacity-20" style={{ backgroundImage: 'linear-gradient(#0D6B4A 1px, transparent 1px), linear-gradient(90deg, #0D6B4A 1px, transparent 1px)', backgroundSize: '30px 30px' }}></div>
        
        {/* Route Path SVG */}
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 390 350">
          <path d="M 120 150 C 150 150, 180 200, 250 220" fill="none" stroke="#0D6B4A" strokeWidth="4" strokeDasharray="8 4" className="opacity-70" />
        </svg>
      ...
      {/* Bottom Section */}
      <div className="h-[55%] w-full bg-white rounded-t-3xl shadow-[0_-4px_20px_rgba(0,0,0,0.1)] z-20 flex flex-col pt-5 pb-8 px-5 absolute bottom-0">
        
        {/* Location Rows */}
        <div className="flex flex-col gap-4 mb-5 relative">
          <div className="absolute left-2.5 top-6 bottom-6 w-0.5 bg-gray-200"></div>
        ...
        <div className="flex gap-3 overflow-x-auto pb-4 -mx-5 px-5 scrollbar-hide">
          {/* Selected Option */}
          <div className="min-w-[110px] bg-green-50 border-2 border-[#0D6B4A] rounded-2xl p-3 flex flex-col relative">
          ...
          <div className="min-w-[110px] bg-white border border-gray-200 rounded-2xl p-3 flex flex-col">
        ...
        <div className="mt-auto flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="text-[14px] font-medium text-[#0D6B4A]">Change</button>
          </div>

          <Button className="w-full bg-[#0D6B4A] text-white hover:bg-[#0a5239] h-14 rounded-full text-[16px] font-bold shadow-md flex justify-between px-6">
