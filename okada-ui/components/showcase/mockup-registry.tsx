...
const PassengerHomeDesktop = () => (
  <BookingDashboard initialBookingState="search" />
);
const PassengerSearchingDesktop = () => (
  <BookingDashboard initialBookingState="searching" />
);
const PassengerAssignedDesktop = () => (
  <BookingDashboard initialBookingState="assigned" />
);
const PassengerProgressDesktop = () => (
  <BookingDashboard initialBookingState="progress" />
);
...
const RiderDocumentDesktop = () => (
  <RiderOnboarding initialTab="onboarding" initialStep={1} />
);
...
const AdminNotificationsDesktop = () => (
  <AdminSettings initialTab="templates" />
);
...
const PassengerLoginScreen = () => (
  <AuthPages initialAuthState="login" audience="passenger" />
);
const PassengerSignupScreen = () => (
  <AuthPages initialAuthState="signup" audience="passenger" />
);
const PassengerForgotScreen = () => (
  <AuthPages initialAuthState="forgot" audience="passenger" />
);
const RiderLoginScreen = () => (
  <AuthPages initialAuthState="login" audience="rider" />
);
const RiderSignupScreen = () => (
  <AuthPages initialAuthState="signup" audience="rider" />
);
const RiderForgotScreen = () => (
  <AuthPages initialAuthState="forgot" audience="rider" />
);
const AdminLoginScreen = () => (
  <AuthPages initialAuthState="login" audience="admin" />
);
...
export function findMockupScreen(slug: string[]) {
  return (
    mockupScreens.find((entry) => entry.slug.join("/") === slug.join("/")) ??
    null
  );
}

export function groupedMockupScreens() {
  return mockupScreens.reduce<Record<string, MockupScreenEntry[]>>(
    (groups, entry) => {
      groups[entry.group] ??= [];
