      ...
      <section className="safety-standards-hero">
        ...
        <div className="exact-landing-container safety-standards-hero-shell">
          <div className="safety-standards-topbar">
            ...
            <div className="safety-standards-kicker">
              OkadaGo Trust & Safety
            </div>
          </div>
          ...
          <div className="safety-standards-hero-grid">
            <div className="safety-standards-hero-copy">
              ...
              <h1>
                Safety is not a hidden feature. It is the operating standard.
              </h1>
              <p>
                OkadaGo is designed around rider verification, helmet
                discipline, live trip visibility, support escalation, and
                professional conduct rules that should be visible before anyone
                books.
              </p>
              ...
              <div className="safety-standards-actions">
                ...
                <Link
                  href="/rider/signup"
                  className="safety-standards-secondary"
                >
                  Become a rider
                </Link>
              </div>
            ...
            <aside className="safety-standards-baseline-card">
              ...
              <div className="safety-standards-baseline-grid">
                <div>
                  <strong>100%</strong>
                  <span>
                    active riders are expected to pass onboarding checks before
                    they go live
                  </span>
                </div>
                <div>
                  <strong>24/7</strong>
                  <span>
                    operations-aware support mindset for active trips and
                    incident review
                  </span>
                </div>
                <div>
                  ...
                  <span>
                    for harassment, intimidation, or fraudulent ride behavior
                  </span>
                </div>
              </div>
            </aside>
      ...
      <section className="safety-standards-section">
        <div className="exact-landing-container safety-standards-story">
          <div className="safety-standards-story-copy">
            ...
            <p>
              These standards shape who gets onboarded, what riders must
              maintain, how trips are monitored, and how the platform reacts
      ...
      <section className="safety-standards-section">
        <div className="exact-landing-container safety-standards-response">
          <div className="safety-standards-response-main">
            <p className="safety-standards-section-label">
              When something goes wrong
            </p>
            <h2>Response matters as much as prevention.</h2>
            <p>
              A safety page should not just promise prevention. It should
              explain what happens when a rider or passenger needs help, wants
              to report an issue, or expects action from the platform.
            </p>
          </div>
          ...
          <aside className="safety-standards-response-panel">
            <div className="safety-standards-response-item">
              ...
              <p>
                Passengers and riders should be able to raise a concern during
                or after the trip without friction.
              </p>
            </div>
            <div className="safety-standards-response-item">
              <h3>2. Review and escalate</h3>
              <p>
                Support teams should assess urgency, preserve trip context, and
                escalate serious incidents fast.
              </p>
            </div>
            <div className="safety-standards-response-item">
              <h3>3. Take action</h3>
              <p>
                Accounts, trip access, and rider status can be restricted when
        ...
        <div className="exact-landing-container">
          <div className="safety-standards-cta">
            <div>
              ...
              <h2>
                Clear standards help riders and passengers know what OkadaGo
                stands for.
              </h2>
            </div>
            <div className="safety-standards-actions">
