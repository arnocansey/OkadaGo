...
const configSchema = z.object({
  ...
  PAYSTACK_DEFAULT_MOMO_BANK_CODE: z.string().min(2).max(16).default("MTN"),
...
export const appConfig = {
  ...
  paystackTransfersEnabled: parsed.PAYSTACK_TRANSFERS_ENABLED === "true",
  paystackDefaultMomoBankCode: parsed.PAYSTACK_DEFAULT_MOMO_BANK_CODE.toUpperCase(),
