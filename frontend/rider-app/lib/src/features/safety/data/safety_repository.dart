...
final riderSafetyRepositoryProvider = Provider<RiderSafetyRepository>((ref) {
  return RiderSafetyRepository(ref.watch(dioProvider));
});
...
class RiderSafetyRepository {
  RiderSafetyRepository(this._dio);
