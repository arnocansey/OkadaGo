...
import 'widgets/rider_auth_widgets.dart';
  ...
  Future<void> _submit() async {
    ...
    try {
      final session = await ref
          .read(riderSessionServiceProvider)
          .signup(
            fullName:
      ...
      setState(() {
        _error = error is Exception
            ...
            : 'Unable to create your rider account right now.';
      });
    } finally {
      if (mounted) {
        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                const RiderAuthLogoLockup(centered: false),
                ...
                Text(
                  'Set up your rider profile to start receiving trips.',
                ...
                if (_error != null) ...[
                  const SizedBox(height: 20),
                  RiderAuthNoticeCard(message: _error!, error: true),
                ],
                ...
                Center(
                  child: TextButton(
                    ...
                    child: const Text('Already a rider? Log in'),
                  ),
                ),
              ],
            ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: active
            ? (muted
                  ? const Color(0xFF9EC5B7)
                  : AppTheme.forest)
            : const Color(0xFFD7DEE7),
        borderRadius: BorderRadius.circular(999),
        boxShadow: active && !muted
            ? [
                BoxShadow(
                  color: AppTheme.forest.withValues(alpha: 0.14),
                  blurRadius: 6,
