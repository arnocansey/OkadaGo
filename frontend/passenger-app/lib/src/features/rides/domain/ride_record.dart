...
class RideRecord {
  ...
  factory RideRecord.fromJson(Map<String, dynamic> json) {
    ...
    final riderUser = rider is Map<String, dynamic>
    ...
    latestLocation ??= () {
      ...
      final latitude = parseDouble(riderMap?['currentLatitude']);
      final longitude = parseDouble(riderMap?['currentLongitude']);
    ...
    return RideRecord(
      ...
      riderName: riderUser?['fullName'] as String?,
      riderPhone: riderUser?['phoneE164'] as String?,
