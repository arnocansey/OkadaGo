...
export const styles = StyleSheet.create({
  ...
  yellowCard: { backgroundColor: palette.yellow, borderColor: palette.orange },
  ...
  bookMapHero: { marginHorizontal: -16, marginTop: -16, marginBottom: -42 },
  bookMapHeroPanel: { height: 330, borderRadius: 0, borderLeftWidth: 0, borderRightWidth: 0, borderTopWidth: 0 },
  bookFloatingCard: { backgroundColor: "rgba(23,18,11,0.96)", borderColor: "rgba(255,122,0,0.34)" },
  ...
  mapGrid: { ...StyleSheet.absoluteFillObject, opacity: 0.11, backgroundColor: palette.orange },
