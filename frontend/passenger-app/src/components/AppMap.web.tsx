...
export function AppMap({
  ...
  return (
    <View style={[styles.wrap, { backgroundColor: isDark ? "#0F172A" : "#F1F5F9" }, style]}>
      {/* Web Vector Grid Map Simulation */}
      <View style={styles.webGridOverlay}>
        <View style={[styles.roadHorizontal, { backgroundColor: isDark ? "#1E293B" : "#E2E8F0" }]} />
        <View style={[styles.roadVertical, { backgroundColor: isDark ? "#1E293B" : "#E2E8F0" }]} />
        <View style={[styles.roadSecondary, { backgroundColor: isDark ? "#1A2333" : "#CBD5E1" }]} />
        ...
        <View style={[styles.locationBadge, { backgroundColor: isDark ? "rgba(15, 23, 42, 0.9)" : "rgba(255, 255, 255, 0.9)", borderColor: colors.border }]}>
          ...
          <Text style={[styles.locationText, { color: colors.text }]}>Accra · Live Pickup Map</Text>
        </View>
