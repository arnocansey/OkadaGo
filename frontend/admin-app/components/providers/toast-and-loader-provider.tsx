        ...
        {loading && (
          ...
          >
            <motion.div
              ...
              className="bg-[var(--surface-elevated)] text-[var(--text-primary)] px-10 py-9 rounded-2xl border border-[var(--border)] flex flex-col items-center shadow-2xl min-w-[220px] max-w-xs text-center"
            >
